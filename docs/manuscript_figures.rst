...
.. list-table::
   ...
   * - Solved VMEC-JAX QA geometry figure
     ...
     - current artifact base:
       ``docs/_static/vmex_qa_solved_boundary_boozer_panel.png``. The
