...
.. list-table::
   ...
   * - Collisional finite-wavelength zonal response
     - ``tools/artifacts/build_zonal_flow_artifacts.py collisional-zonal-dk``
   ...
   * - W7-X fluctuation spectrum
     ...
     - ``docs/_static/w7x_fluctuation_spectrum_panel.json``: simulation
       ...
       comparison.
   * - TEM branch audit
     - ``tools/artifacts/build_tem_validation_artifacts.py``
...
.. list-table::
   ...
   * - Solver-objective and VMEC/Boozer gradient gates
     - ``tools/artifacts/build_solver_objective_gradient_gate.py``
   ...
   * - Inverse and UQ
     - ``examples/theory_and_demos/autodiff_inverse_growth.py``,
       ...
       ``tools/artifacts/plot_stellarator_optimization_uq.py``
...
``tools/release/check_quasilinear_promotion_guardrails.py`` reads this list:
