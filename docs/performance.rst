...
.. code-block:: bash
   ...
   python benchmarks/performance/benchmark_nonlinear_suite.py --gx-log reference_run.out
...
``python tools/artifacts/plot_scaling_panels.py legacy-two-device``, not a
