...
arithmetic (``scripts/artifacts/build_linear_validation_artifacts.py`` and
``scripts/artifacts/build_finite_wavelength_coulomb_data.py``), records
...
``scripts/artifacts/build_landau_damping_figure.py``.
