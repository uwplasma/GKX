...
.. list-table::
   ...
   * - ``tools/``
     - Tests for ``tools/comparison`` and ``tools/profiling`` scripts.
   * - ``release/``
...
.. code-block:: bash
   ...
   python tools/release/run_test_gates.py fast --total-timeout 0   # full sequential pass
...
.. list-table::
   ...
   * - ``wide-coverage-shards``
     - 24 shards of ``tools/release/run_test_gates.py wide-coverage`` with
...
.. list-table::
   ...
   * - ``tools/artifacts/generate_linear_reference_overlays.py kbm`` / ``w7x``
   ...
   * - ``tools/artifacts/build_w7x_zonal_validation_artifacts.py`` and
       ``tools/artifacts/build_w7x_zonal_reference_artifacts.py compare``
   ...
   * - ``tools/comparison/build_exact_state_audit.py report``
   ...
   * - ``tools/release/check_nonlinear_optimization_gates.py production-guard``
