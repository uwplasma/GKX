...
.. list-table::
   ...
   * - Plotting tools
     - ``tools/artifacts/plot_quasilinear_diagnostics.py``,
...
``tools/release/check_nonlinear_transport_gates.py convergence`` and records the
...
``tools/release/check_quasilinear_promotion_guardrails.py calibration-inputs``
...
calibration. ``tools/release/check_quasilinear_promotion_guardrails.py``
...
0.02 nonlinear-launch threshold of ``tools/artifacts/build_qi_branch_refinement_gate.py``,
