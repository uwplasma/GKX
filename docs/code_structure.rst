...
``scripts/checks/check_validation_coverage_manifest.py``. A direct
...
.. code-block:: bash
   ...
   python scripts/checks/check_repository_size_manifest.py audit --top 30
   python scripts/checks/check_repository_size_manifest.py
   python scripts/checks/check_repository_size_manifest.py release-artifacts
...
.. code-block:: bash
   ...
   python scripts/checks/check_repository_size_manifest.py compress-previews --mode release --max-width 2200 --colors 192
   python scripts/checks/check_repository_size_manifest.py compress-previews --mode docs --min-bytes 300000 --max-width 1800 --colors 192
