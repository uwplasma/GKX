...
Gyrokinetic code verification has a settled hierarchy. GKX's position in each
class:
...
This is the already-instrumented instance of the recurrence problem, on the one
benchmark where GKX disagrees with two established codes.
...
GENE. That is a direct, method-matched target for GKX to reproduce.
...
integrator* with a manufactured RK2 case and its operator not at all.

Ordered work
------------

Each item names its test class.
...
exercises zonal drive, Landau damping and saturation simultaneously.
