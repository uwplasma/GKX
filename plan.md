...
`fix/r0-end-damping-rate`, head **93062763**, worktree
...
| Tests/startup | CPU/GPU boundary and route probes; coupled reverse AD vs matrix exponential; 88 linear, 78 time-integrator, 198 release, 148 CLI tests passed in recorded runs; nonfinite Laguerre transform errors now rejected, 50 core numerics tests pass | Fresh full CI; direct JVP through custom-VJP field solve remains unsupported |
