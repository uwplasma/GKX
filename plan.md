...
|---|---|---|
| Research-grade release 2.3.0 (2.1.0 and 2.2.0 were cut as intermediate releases on 2026-09-15 and 2026-09-20; these exits were not required for either) | #192 repaired; every README/docs number ledger-gated; ES atlas and nonlinear validation closed; EM0–EM3 closed, EM4 linear closed; statistics protocol; citation and DOI | 0–3, 7 |
...
2. `CITATION.cff` (added). Mint a Zenodo DOI at 2.3.0 and add the badge.
...
recorded; EM5 linear/QL derivative rows passing. Required for 2.3.0.
...
3. Release 2.3.0 only when: Phase 0–3 exits met (EM4 nonlinear excepted),
...
- [ ] 7 docs generated from the ledger; examples regenerate; paper 1 bundle; 2.3.0 reviewed by the maintainer.
