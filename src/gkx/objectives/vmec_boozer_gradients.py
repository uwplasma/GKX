    ...
    *,
    ...
    payload = _mode21_gradient_base_payload(
        ...
        claim_scope=(
            ...
            "-> GKX linear-RHS eigenpair -> reduced nonlinear-window estimator gradient"
        ),
    )
    return _update_mode21_gradient_payload(
        ...
        next_action=(
            ...
            "heat-flux optimization still requires converged nonlinear GKX window gradients "
...
def mode21_vmec_boozer_linear_frequency_gradient_report(  # pragma: no cover
    *,
    ...
    builds the GKX linear RHS, and compares implicit eigenpair
    ...
    payload = _mode21_gradient_base_payload(
        ...
        claim_scope=(
            ...
            "geometry -> GKX linear-RHS eigenfrequency gradient"
        ),
    )
    return _update_mode21_gradient_payload(
        payload,
...
def mode21_vmec_boozer_quasilinear_gradient_report(  # pragma: no cover
    *,
    ...
    payload = _mode21_gradient_base_payload(
        ...
        claim_scope=(
            "full vmex state coefficient -> booz_xform_jax mode-21 equal-arc "
            "geometry -> GKX linear-RHS quasilinear heat-flux-weight gradient"
        ),
    )
    return _update_mode21_gradient_payload(
        payload,
...
def mode21_vmec_boozer_nonlinear_window_gradient_report(  # pragma: no cover
    *,
    ...
    GKX linear-RHS path from the quasilinear gradient gate, then feeds
