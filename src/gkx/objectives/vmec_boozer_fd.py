    ...
    *,
    ...
    return {
        ...
        "claim_scope": (
            ...
            "VMECState -> booz_xform_jax -> GKX value evaluator; not an AD or nonlinear transport claim"
        ),
        **_base_report_fields(
            case_name=case_name,
            objective=objective,
    ...
    *,
    ...
    return {
        ...
        "claim_scope": (
            ...
            "VMEC/Boozer/GKX objective over fixed surfaces, field lines, and ky points; "
...
def vmec_boozer_scalar_objective_finite_difference_report(  # pragma: no cover
    ...
    **kwargs: Any,
    ...
    ``vmex`` state, evaluates the in-memory VMEC/Boozer/GKX scalar
