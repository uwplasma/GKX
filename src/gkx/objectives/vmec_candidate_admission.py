...
def build_authoritative_wout_candidate_gate(
    ...
    *,
    ...
    return {
        ...
        "next_action": (
            "this WOUT may be used as the authoritative equilibrium for downstream GKX audits"
            if passed
            else "do not use this WOUT for downstream GKX transport promotion"
        ),
    }
...
def build_wout_reproducibility_gate(
    ...
    *,
    ...
    must reproduce the WOUT when rerun; otherwise downstream GKX
    ...
    return {
        ...
        "rerun_wout": rerun,
        "checks": checks,
        "claim_level": "saved VMEC input must reproduce optimizer-state WOUT before GKX transport promotion",
        "next_action": (
...
def build_solved_vmec_candidate_gate(
    ...
    *,
    ...
    return {
        ...
        "passed": bool(passed),
        "checks": checks,
        "claim_level": "solved VMEC candidate gate before expensive GKX nonlinear transport audit",
        "next_action": (
