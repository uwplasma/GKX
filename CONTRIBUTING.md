...
for c in size architecture parallel-scaling quasilinear vmec-boozer readiness validation-coverage nonlinear-transport; do python scripts/check.py "$c" || echo "FAILED $c"; done
```
