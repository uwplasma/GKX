...
from scripts.artifacts.build_solver_objective_gradient_gate import _json_clean  # noqa: E402
...
def _annotate_payload(
    ...
    *,
    ...
    annotated["builder"] = (
        "scripts/artifacts/build_vmec_boozer_aggregate_objective_gate.py multi-point"
    )
...
def _fail_closed_payload(
    *,
    ...
    return {
        ...
        "builder": "scripts/artifacts/build_vmec_boozer_aggregate_objective_gate.py second-equilibrium",
        "passed": False,
        "feasible": False,
        "case_name": str(case_name),
