...
- Files expected to change: `src/gkx/diagnostics/zonal_validation.py`, `src/gkx/solvers_time_explicit_diagnostics.py`, `pyproject.toml` optional extras, and focused unit/release packaging tests only.
