...
GitHub reports 73 merged PRs through #80. None has an approving review. The
...
| 42 | README movie | S | Documentation pointed to a pre-rendered synthetic circular-torus movie. Replace with lightweight output-derived movies after #86. |
...
| 48 | nonlinear AD/QA optimization | D | Consolidates to checkpointed finite-window reverse mode and removes much obsolete material. It was merged despite the no-merge request and promotes single-campaign evidence too far; keep the implementation, narrow claims, repeat AD/FD and transport campaigns. |
