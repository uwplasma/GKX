...
| 48 | merged despite the stated no-merge workflow; finite-window evidence was promoted beyond replicated validation, and the 2048-step prose contradicted its failed JSON gate | PR #100 narrows the claim; rerun source-pinned AD/FD and independent QA campaigns |
